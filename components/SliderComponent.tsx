...
const SliderComponent = () => {
 ...
 <section className="social-section-wrapper lg:h-[41.25rem] md:h-[43.35rem]  mb-0 ml-[calc(50% - 800px)] p-[4rem 0] w-full flex lg:flex-row lg:mt-5 md:mt-8 sm:flex-col-reverse md:flex-col-reverse md:justify-between sm:gap-10 relative">
        <div className="lg:ml-[8rem] sm:ml-[2rem]  lg:w-[29rem] md:w-[40rem] md:max-w-[50rem] md:mx-[12rem]  flex flex-col sm:max-w-[30rem] mb-4 ">
          ...
          <p className="text-body mt-4 font-normal">
        ...
        {/* w-[calc(100% - 1000px)] */}
        {/* lg:h-[37.5rem] */}
        <div className="card carousel lg:h-[30rem] lg:w-[39rem] lg:left-[40.25rem] md:h-[28.5rem] md:left-[10.25rem] md:absolute lg:absolute sm:top-[60px] sm:left-[6rem] flex justify-center mb-[1rem] sm:overflow-x-hidden sm:h-[28rem] sm:w-[24rem] sm:mx-10 md:mx-10 sm:max-w-[50rem] md:max-w-[50rem] md:w-[30rem] lg:max-w-[50rem]">
          <Swiper 
          slidesPerView={3}
            spaceBetween={160}                                                            
