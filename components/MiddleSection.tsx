      ...
      <section className="roamies-section-wrapper items-center bg-[#121417] clip-path-blacksection flex flex-row justify-center min-h-[50rem] p-[0 1rem] w-full ">
        <div className="first-div flex lg:flex-row justify-between items-center lg:w-[80%] sm:flex-col-reverse sm:w-full ">
          <div className="text flex flex-col lg:w-[50%] sm:w-[80%]">
            ...
            <div className="text-white bg-[#cc0074] rounded-2xl text-center w-[8rem] p-1 mt-2 sm:ml-[6rem] lg:ml-[0]">
              <Button className="flex lg:justify-start items-center sm:justify-center font-bold ">
                Show Me
              </Button>
            </div>
          </div>
...
{/* animated section */}
      <section className="hc-section-wrapper h-[80rem] pb-[2rem] overflow-hidden relative w-full mb-8">


        {/* mobile section */}
      <div className='cards-mobile-container'>
        <div className='row first-row sm:animate-[rowanimation_wiggle_10s_linear_infinite] sm:flex sm:flex-nowrap sm:w-fitcontentsm: ml-[1.75rem] sm:gap-[1.75rem]'>
          
{/* //1 */}

<div
            className="card-wrapper left-[1200px] top-[180px] transform translate-y-[100px] rotate-[-15deg] bg-[#fff]
    rounded-3xl
...
{/* 2 */}
<div
            className="card-wrapper left-[600px] top-[120px] transform translate-x-[300px] translate-y-[450px] rotate-[-15deg] z-[110]    bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
 ...
 <div
            className="card-wrapper  left-[850px] top-[160px] transform translate-x-[-100px] translate-y-[100px] rotate-[-15deg]  bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
...
<div
            className="card-wrapper  left-[350px] top-[140px] transform translate-x-[-40px] translate-y-[100px] rotate-[-15deg] bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle_1.6s_ease-out_.4s_forwards]"
        ...
        <div className='row second-row animate-[secondrowanimation_8s_linear_infinite] sm:mt-2 sm:flex sm:gap-[1.75rem] sm:flex-nowrap sm:w-fit'>

{/* 1 */}


<div
            className="card-wrapper left-[220px] top-[910px] transform translate-x-[200px] translate-y-[70px] rotate-[-15deg] bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle7_1.6s_ease-out_.4s_forwards]"
          ...
          <div
            className="card-wrapper left-[1300px] top-[500px] transform translate-y-[150px] rotate-[-15deg]   bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle5_1.6s_ease-out_.4s_forwards]"
          ...
          <div
            className="card-wrapper left-[1400px] top-[950px] transform translate-x-[-100px] translate-y-[0px] rotate-[-15deg] z-[110]    bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    flex-col
    h-fit
    p-[.375rem] w-[14.5rem] animate-wiggle 1.6s ease-out .4s forwards"
          >
            <video
              className="h-[12rem] rounded-3xl mb-[0.75rem] object-cover pointer"
              autoPlay
...
{/* 4 */}
<div
            className="card-wrapper left-[1100px] top-[890px] transform translate-x-[-100px] translate-y-[0px] rotate-[-15deg]   bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle9_1.6s_ease-out_.4s_forwards]"
          ...
          <div
            className="card-wrapper-desktop  lg:left-[350px] lg:top-[140px] lg:transform translate-x-[-40px] translate-y-[100px] rotate-[-15deg] lg:bg-[#fff]
    lg:rounded-3xl
    ...
    lg:flex-col
    lg:h-fit
    lg:p-[.375rem] lg:w-[14.5rem] lg:animate-[wiggle_1.6s_ease-out_.4s_forwards]"
          >
            <video
              className="h-[12rem] rounded-3xl mb-[0.75rem] object-cover pointer"
              autoPlay
...
<div
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle7_1.6s_ease-out_.4s_forwards]"
          ...
          <div
            className="card-wrapper left-[570px] top-[900px] transform translate-x-[100px] translate-y-[0px] rotate-[-15deg] z-[110]    bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    p-[.375rem] w-[14.5rem] animate-[wiggle9_1.6s_ease-out_.4s_forwards]"
          ...
          <div
            className="card-wrapper left-[40px] top-[1000px] transform translate-x-[80px] translate-y-[0px] rotate-[-15deg] z-[110]    bg-[#fff]
    rounded-3xl
    shadow-[0_4px_32px_#0000001a]
    pointer absolute
    flex
    ...
    <div className="text-animate animate-[animate_1.6s_ease-out_.4s_forwards]  absolute left-[8rem] top-[35rem] max-w-[42rem] mt-[4rem]">
            <h2 className="font-extrabold text-4xl mb-[1rem] leading-10 tracking-tight">
              The world’s best hostels, with over{" "}
              <span className="text-[#30cf72]">13 million reviews</span>.
            </h2>
            <p className="text-lg">
              With over 16,500 hostels in 180 countries, there’s always room for
              a new adventure!
            </p>
          </div> 
