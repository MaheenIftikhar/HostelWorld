      ...
      <div className="say-hello-wrapper flex lg:flex-col items-center justify-center mr-0 relative lg:mt-40">
        <div className="say-hello-container block mb-[4rem] max-w-[62.5rem]">
          ...
          <div className="chat-windows lg:h-[41rem] ml-[19.5rem] mt-[2rem] w-[23.4375rem]">
            <img
              className="block absolute lg:top-60 z-20  sm:left-[13.2rem] lg:left-[34rem] sm:top-[13rem] sm:w-[220px] md:left-[24rem] md:w-[300px]"
          ...
          <div className="sh-chat lg:h-[14rem] ml-[19.5rem] mt-[ 2rem] w-[23.4375rem]">
            ...
            ></img>
            <img
              className="top-[5.875rem] absolute rounded-3xl left-[16rem] z-10 transform translate-y-[55px] transition duration-300 lg:block sm:hidden"
...
{/* steps-wrapper */}
        ...
        z-20 "
              ...
              <div
                ...
                transition duration-[0.3s] before:rounded-full before:shadow-[0_0_0_3px_#fff] before:left-[-2.1875rem] before:top-[0.375rem] before:absolute before:border-l-[3px_dashed_#dddfe4] before:w-[1.3125rem] before:h-[1.3125rem]
                 before:bg-[#dddfe4]
        before:z-[10]"
              >
                Hostel Chat
        ...
        z-20 "
              ...
              <div
                className="step step-active text-[#7f32cd] text-lg font-extrabold pointer tracking-tight leading-8 max-h-[1.75rem] max-w-[17.6875rem] relative 
                transition duration-[0.3s] before:rounded-full before:shadow-[0_0_0_3px_#fff] before:h-[1.3125rem] before:left-[-2.300rem] before:top-[0.600rem] before:absolute before:z-[10] before:border-l-[3px_dashed_#dddfe4] before:w-[1.3125rem] before:bg-[#dddfe4]
        before:z-1"
              >
                City Chat
              </div>
