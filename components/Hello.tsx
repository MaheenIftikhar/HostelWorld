       ...
       <section className='say-hello-section w-full'>
          <div className='say-hello-wrapper flex lg:flex-col items-center justify-center mr-0 relative lg:mt-40'>
            <div className='say-hello-container block mb-[4rem] max-w-[62.5rem]'>
              <div className='say-hello-heading lg:m-[0_0_2rem_20rem] lg:pl-[1.5rem] sm:m-[22rem_2rem_2rem_2rem]  lg:w-full lg:absolute lg:left-[16rem] sm:w-[300px]'>
              ...
              <div className='chat-windows lg:h-[41rem] ml-[19.5rem] mt-[2rem] w-[23.4375rem]'> 
                  <img className='block absolute lg:top-60 z-20  sm:left-[22rem] lg:left-[34rem] sm:top-[10rem] sm:w-[300px]' src='https://a.hwstatic.com/image/upload/f_auto,h_656,w_375,q_50/v1645433308/pwa/chat/chat-hostel.png'></img>
             ...
             <img className='top-[5.875rem]  absolute rounded-3xl left-[2rem] sm:block lg:hidden sm:w-[370px]' src='https://a.hwstatic.com/image/upload/f_auto,h_226,w_370,q_50/v1644506518/pwa/chat/chat-image-1-sm.jpg'></img>
